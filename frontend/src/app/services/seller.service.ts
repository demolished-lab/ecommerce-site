...
export class SellerService {
  ...
  getSellerBySlug(slug: string): Observable<Seller> {
    return this.http
      .get<{ success: boolean; data: Seller }>(`${this.apiUrl}/${slug}`)
      .pipe(map((response) => response.data));
  }
  ...
  getMySellerProfile(): Observable<Seller> {
    return this.http
      .get<{ success: boolean; data: Seller }>(`${this.apiUrl}/me`)
      .pipe(map((response) => response.data));
  }
  ...
  getSalesReport(period: "week" | "month" | "year" = "month"): Observable<any> {
    return this.http
      .get<{
        success: boolean;
        data: any;
      }>(`${this.apiUrl}/dashboard/sales-report`, { params: { period } })
      .pipe(map((response) => response.data));
  }
  ...
  uploadDocument(
    ...
    return this.http
      .post<{
        success: boolean;
        data: { id: string; file_url: string };
      }>(`${this.apiUrl}/${sellerId}/documents`, formData)
      .pipe(map((response) => response.data));
  }
  ...
  getPendingApplications(): Observable<Seller[]> {
    return this.http
      .get<{ success: boolean; data: Seller[] }>(`${this.apiUrl}/admin/pending`)
      .pipe(map((response) => response.data));
  }
  ...
  reviewApplication(
    ...
    return this.http
      .post<{
        success: boolean;
        data: Seller;
      }>(`${this.apiUrl}/${sellerId}/review`, { action, reason, notes })
      .pipe(map((response) => response.data));
  }
  ...
  updateSellerSettings(
    ...
    return this.http
      .put<{
        success: boolean;
        data: Seller;
      }>(`${this.apiUrl}/${sellerId}/settings`, settings)
      .pipe(map((response) => response.data));
  }
}
