...
export class OrderService {
  ...
  createOrder(orderData: OrderCreate): Observable<Order> {
    return this.http
      .post<{ success: boolean; data: Order }>(this.apiUrl, orderData)
  ...
  getOrderById(id: string): Observable<Order> {
    return this.http
      .get<{ success: boolean; data: Order }>(`${this.apiUrl}/${id}`)
      .pipe(map((response) => response.data));
  }
  ...
  getShippingRates(address: ShippingAddress): Observable<ShippingRate[]> {
    return this.http
      .post<{
        success: boolean;
        data: ShippingRate[];
      }>(`${this.apiUrl}/shipping-rates`, address)
      .pipe(map((response) => response.data));
  }
  ...
  getOrderStatistics(): Observable<{
    ...
    return this.http
      .get<{ success: boolean; data: any }>(`${this.apiUrl}/statistics`)
      .pipe(map((response) => response.data));
  }
}
