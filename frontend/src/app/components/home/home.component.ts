    ...
    <div class="home-container">
        ...
        <div class="container">
          <div class="hero-content">
            ...
            <p class="hero-subtitle">
              Shop from thousands of sellers worldwide. Find unique items, great deals, and support small businesses.
            </p>
            <div class="hero-actions">
              <a mat-raised-button color="primary" routerLink="/products" class="hero-btn">
                Shop Now
                <mat-icon>arrow_forward</mat-icon>
              </a>
              <a mat-stroked-button routerLink="/become-seller" class="hero-btn">
                Start Selling
              </a>
            </div>
          </div>
          ...
          <div class="categories-grid" *ngIf="categories$ | async as categories">
            ...
            >
              <mat-card-content class="category-content">
                <mat-icon class="category-icon" *ngIf="category.icon">{{ category.icon }}</mat-icon>
                <mat-icon class="category-icon" *ngIf="!category.icon">category</mat-icon>
                <h3 class="category-name">{{ category.name }}</h3>
                <p class="category-count">{{ category.product_count || 0 }} Products</p>
              </mat-card-content>
            </mat-card>
          </div>
        </div>
      ...
      <section class="featured-section">
        <div class="container">
          ...
          <div class="products-grid" *ngIf="featuredProducts$ | async as products">
            <mat-card
            ...
            >
              <div class="product-image-container">
                <img
                  [src]="product.primary_image || '/assets/placeholder-product.png'"
                  [alt]="product.title"
                  class="product-image"
                >
              ...
              <mat-card-actions>
                <button mat-button color="primary" (click)="addToCart($event, product)">
